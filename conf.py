...
BLOG_AUTHOR = "Joel \"Jaykul\" Bennett"  # (translatable)
...
BLOG_EMAIL = "Jaykul@HuddledMasses.org"
BLOG_DESCRIPTION = "You can do more than breathe for free..."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "huddledmasses"
...
# (translatable)
#  SEARCH_FORM = "<iframe src='http://duckduckgo.com/search.html?width=350&site=huddledMasses.org&prefill=Search Huddled Masses' style='overflow:hidden;margin:0;padding:0;width:408px;height:40px;' frameborder='0'></iframe>"
